...
public:
     ...
     * Return:return 0 if successful, otherwise return an error code.
     ******************************************/
    virtual int do_get_request(const std::string &url, const std::list<std::string> &add_headers, HTTPS_RESPONSE &response) = 0;
    /******************************************
     ...
     * Return:return 0 if successful, otherwise return an error code.
     ******************************************/
    virtual int do_post_request(const std::string &url, const std::list<std::string> &add_headers, const std::string &body, HTTPS_RESPONSE &response) = 0;
    /******************************************
      * Name:https_clear
